    ...
    <div class="px-5 mx-auto max-w-7xl">
        <div class="flex items-center justify-between text-gray-700">
            ...
            <div class="hidden space-x-5 sm:block">
                <a href="/#feature"
                    class="text-gray-600 transition duration-300 ease-in-out hover:text-gray-800">Feature</a>
                <a href="/#aboutUs"
                    class="text-gray-600 transition duration-300 ease-in-out hover:text-gray-800">About</a>
                <a href="/nurses"
                    class="text-gray-600 transition duration-300 ease-in-out hover:text-gray-800">Nurses</a>
                <a href="/login"
            ...
            <button class="navbar sm:hidden" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation"
