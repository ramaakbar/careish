<x-main-layout>
    <x-user-layout>
        ...
        <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div id="dropdownDotsHorizontal"
                            ...
                            <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdownMenuIconHorizontalButton">
                                <li>
                                    <a href="#" class="block px-4 py-2 hover:bg-gray-100">Edit
                                        Review</a>
                                </li>
                                <li>
                                    <form action="/user/reviews/{{ $review->id }}" method="POST">
                                        @csrf
                                        @method('delete')
                                        <button
                                            class="block w-full px-4 py-2 text-left hover:bg-red-600 hover:text-white">Delete
                                            Review</button>
                                    </form>
                                </li>
                            </ul>
            ...
            @empty
                <div>You havent reviewed nurses yet</div>
            @endforelse
