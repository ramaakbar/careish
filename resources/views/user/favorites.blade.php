        ...
        <div
            ...
            @forelse ($favorites as $favorite)
                <div class="w-full overflow-hidden rounded-lg shadow-lg">
                    <a href="/nurses/detail/{{ $favorite->nurseId }}">
                        <img class="w-full h-80" src="{{ asset('/storage/' . $favorite->nursePic) }}" alt="">
                        <div class="m-5">
                            <p class="font-bold">{{ $favorite->nurseName }}</p>
                            <div class="mt-2">
                                <div class="flex justify-between">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p>{{ number_format($favorite->rating, 1, '.', ',') }}/5.0</p>
                                    </div>
                                </div>
                                <p>{{ $favorite->nurseAge }} Tahun</p>
            ...
            @empty
                <div class="col-span-3 mt-10 space-y-5 mx-auto">
                    <div class="w-56">
