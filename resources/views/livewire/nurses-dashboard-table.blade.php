<div>
    ...
    <div class="w-full bg-white border rounded">
                    ...
                    @forelse ($nurses as $nurse)
                        <tr wire:loading.remove class="bg-white border-b">
                            ...
                            <td class="flex flex-wrap gap-1 px-6 py-4">
                                ...
                                <button wire:click="getDeleteId({{ $nurse->id }})" data-modal-toggle="confirm-modal" class="px-3 font-medium text-red-600 hover:underline">Delete</button>
                            </td>
                        </tr>
                    @empty
        ...
        @endif
         ...
         {{-- confirm modal --}}
         <div>
         <div wire:ignore.self id="confirm-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
            <div class="relative w-full h-full max-w-md p-4 md:h-auto">
                <div class="relative bg-white rounded-lg shadow">
                    <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="confirm-modal">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <button wire:click.prevent="delete()" data-modal-toggle="confirm-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                            Yes, I'm sure
                        </button>
                        <button data-modal-toggle="confirm-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">No, cancel</button>
                    </div>
                </div>
            </div>
        </div>
